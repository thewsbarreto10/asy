...
<link rel="stylesheet" href="<?= ASSETS_URL ?>/css/estilo_dashboard.css">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-6">
          <div class="small-box bg-info">
            ...
            <a href="#" class="small-box-footer">Cadastrar usuários <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-6">
          <div class="small-box bg-success">
            ...
            <div class="icon"><i class="fas fa-shopping-cart"></i></div>
            <a href="#" class="small-box-footer">Cadastrar eventos <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-6">
          <div class="small-box bg-warning">
            <div class="inner"><h3>150</h3><p>cursos</p></div>
            <div class="icon"><i class="fas fa-shopping-cart"></i></div>
            <a href="#" class="small-box-footer">Subir vídeos <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-6">
...
<script src="<?= ASSETS_URL ?>/js/script_dashboard.js"></script>
<script>
