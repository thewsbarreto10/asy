...
$baseURL = 'http://localhost/asy'; // seu domínio + pasta base
...
<div class="content-wrapper">
  ...
  <span class="badge 
    <?= $curso['statusCurso'] === 'ativo' ? 'bg-success' : 'bg-danger' ?>">
    <?= htmlspecialchars($curso['statusCurso']) ?>
  </span>
</li>
          </ul>
    ...
    <div class="col-md-6">
      <div class="position-relative">
        <i class="fas fa-church icon-left"></i>
                ...
                <select id="selectMinisterioBatch" class="form-control input-com-icone">
